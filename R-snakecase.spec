...
Version  : 0.10.0
Release  : 13
URL      : https://cran.r-project.org/src/contrib/snakecase_0.10.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/snakecase_0.10.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1558058618
